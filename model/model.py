...
class TFT(nn.Layer):
    ...
    def apply_embedding(self, x, static_embedding, apply_masking):
        ...
        static_embedding = paddle.concat(time_varying_categoical_embedding.size(1) * [static_embedding])
        static_embedding = static_embedding.reshape\
            (time_varying_categoical_embedding.size(0),
